" Name:         Apprentice8
" Description:  A conversion of Apprentice by Romain Lafourcade <romainlafourcade@gmail.com> to Colortemplate (with a few small changes)
" Author:       Romain Lafourcade <romainlafourcade@gmail.com>
" Maintainer:   Aramis Razzaghipour <aramisnoah@gmail.com>
" License:      Vim License (see `:help license`)
" Last Updated: Sat 23 Feb 17:10:58 2019

if !(has('termguicolors') && &termguicolors) && !has('gui_running')
      \ && (!exists('&t_Co') || &t_Co < (get(g:, 'apprentice8_use16', &t_Co < 256) ? 16 : 256))
  echoerr '[Apprentice8] There are not enough colors.'
  finish
endif
...
let g:colors_name = 'apprentice8'

" 256-color variant
if !get(g:, 'apprentice8_use16', &t_Co < 256)
